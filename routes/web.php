...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware(['role:admin,sekjur,kajur'])->group(function () {
            ...
            Route::get('verifikasi', [\App\Http\Controllers\TorController::class, 'verifikasi'])->name('verifikasi.index');

            Route::post('verifikasi/{submisi}', [\App\Http\Controllers\TorController::class, 'approveOrReject'])->name('verifikasi.approveOrReject');
