...
export default function NotificationsPage({
    ...
    const handleMarkReadUnread = (read: boolean) => {
        ...
        const url = read
            ? '/dashboard/notifikasi/mark-read'
            : '/dashboard/notifikasi/mark-unread';
            ...
            <div className="flex h-full flex-1 bg-[#CBEBD5]/70 p-4 md:p-6">
                <div className="flex flex-1 flex-col gap-4 rounded-2xl bg-[#E6F5EC] p-4 md:p-6">
                    ...
                    <div className="mt-2 flex-1 space-y-2 overflow-y-auto rounded-2xl">
                        {pageItems.length === 0 ? (
                            <div className="flex h-40 flex-col items-center justify-center rounded-xl border border-dashed border-slate-300 bg-white text-sm text-slate-600">
