...
export default function SubmissionDetailView({ submisi }: SubmissionDetailViewProps) {
    const data = {
        ...
        <>
            <Card className="overflow-hidden rounded-2xl border border-[#73AD86]/40 shadow-sm">
                ...
                <CardContent className="space-y-4 pt-4">
                    ...
                    <div className="space-y-1 md:w-1/2">
                        <Label>PIC</Label>
                        <Input value={submisi.detail_submisi?.pic?.name || 'N/A'} readOnly className="bg-neutral-100" />
                    </div>
                </CardContent>
            </Card>
